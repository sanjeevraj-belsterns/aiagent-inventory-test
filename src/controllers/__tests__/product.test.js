...
describe('Product Controller', () => {
  ...
  describe('addProduct', () => {
    it('should add a product successfully', async () => {
      ...
      expect(ProductModel.create).toHaveBeenCalledWith({ ...mockProduct, productImage: mockImageUrl });
    });
  ...
  describe('getProductsByBrandId', () => {
    it('should return products by brand ID', async () => {
      const mockProducts = [{ productName: 'Test Product', brandId: '123' }];
  ...
  describe('deleteProduct', () => {
    ...
    it('should return 400 if no product ID provided', async () => {
      const response = await request(app)
        .delete('/api/products');
  ...
  describe('getProductsForInvoice', () => {
    it('should return products for invoice', async () => {
      const mockInvoiceProducts = [{ _id: '123', productName: 'Test Product' }];
  ...
  describe('getLowStockProducts', () => {
    it('should return low stock products', async () => {
      const mockLowStockProducts = [{ _id: '123', productName: 'Low Stock Product' }];
