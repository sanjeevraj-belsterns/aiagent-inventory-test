...
describe('Brand Controller', () => {
  ...
  describe('addBrand', () => {
    it('should add a brand and return it', async () => {
      const mockBrand = { brandName: 'Test Brand', brandImage: 'http://example.com/image.jpg' };
      BrandModel.create.mockResolvedValue(mockBrand);

      const response = await request(app)
        .post('/api/brands')
        .send({ brandName: 'Test Brand', brandImage: 'http://example.com/image.jpg' });
  ...
  describe('getAllBrand', () => {
    it('should return all brands', async () => {
      const mockBrands = [{ brandName: 'Brand 1' }, { brandName: 'Brand 2' }];
  ...
  describe('updateBrand', () => {
    it('should update a brand and return it', async () => {
      const mockBrand = { _id: '1', brandName: 'Updated Brand', brandImage: 'http://example.com/image.jpg' };
